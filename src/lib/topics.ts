...
// Lista compartilhada em ./generic-terms (também usada pela validação do editorial).
// Bug #7: ampliada significativamente — antes vinha "Acidente", "Motorista", "VÍDEO"
// como tema; agora filtra esses + dezenas de outros termos genéricos do nicho.
